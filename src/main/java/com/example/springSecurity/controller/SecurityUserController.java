...
public class SecurityUserController {
	...
	public String registerProc(String uid, String pwd, String pwd2, String uname, String email, MultipartHttpServletRequest req,
			Model model) {
		...
		if (securityUser != null) {
			model.addAttribute("msg", "사용자 ID가 충복되었습니다.");
